...
export default function PageSubtitle({ children, addClassName }: IPageSubtitle) {
  const tailwindClassNames = addClassName
    ? `mt-[60px] mb-7 xl:mb-9 font-heading font-bold text-2xl xl:text-[28px] text-[#f7f5f9] ${addClassName}`
    : 'mt-[60px] mb-7 xl:mb-9 font-heading font-bold text-2xl xl:text-[28px] text-[#f7f5f9]'
