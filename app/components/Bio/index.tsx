export default function Bio() {
  return (
    <p className="my-8 font-body text-sm/6 md:text-base/7 text-secondary">
      Hey there! Welcome to my space. Here's where I want to share some of the things I'm learning
      in this world as a software developer. I hope you find what you looking for.{' '}
      <span className="inline md:block">Good luck!</span>
    </p>
  )
}
